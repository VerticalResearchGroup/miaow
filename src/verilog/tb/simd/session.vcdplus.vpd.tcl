...
# DVE full session
# Saved on Thu Mar 14 16:20:59 2013
# Designs open: 1
#   V1: vcdplus.vpd
# Toplevel windows open: 2
# 	TopLevel.1
# 	TopLevel.2
#   Source.1: simd_tb.simd.alu
#   Wave.1: 21 signals
#   Group count = 7
...
#<Session mode="Full" path="/afs/cs.wisc.edu/u/r/p/rprakash/gpu/miaow/src/verilog/tb/simd/session.vcdplus.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{16 46} {1391 836}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 308} {height 514} {dock_state left} {dock_on_new_line true} {child_hier_colhier 291} {child_hier_coltype 10} {child_hier_col1 0} {child_hier_col2 1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 367]
set Data.1 [gui_share_window -id ${DLPane.1} -type Data]
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 367
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 688
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 366} {height 514} {dock_state left} {dock_on_new_line true} {child_data_colvariable 183} {child_data_colvalue 102} {child_data_coltype 90} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 1103} {height 177} {dock_state bottom} {dock_on_new_line false}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{123 113} {1500 905}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 399} {child_wave_right 973} {child_wave_colname 197} {child_wave_colvalue 197} {child_wave_col1 0} {child_wave_col2 1}}
...
catch {gui_list_select -id ${Hier.1} {simd_tb.simd.alu}}
...
gui_open_source -id ${Source.1}  -replace -active simd_tb.simd.alu /afs/cs.wisc.edu/u/r/p/rprakash/gpu/miaow/src/verilog/rtl/alu/build/alu.v
...
gui_list_select -id ${Wave.1} {simd_tb.simd.alu.exec_rd_exec_value }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group2  -item {simd_tb.simd.alu.exec_rd_exec_value[63:0]} -position below
...
gui_list_show_data -id ${Data.1} {simd_tb.simd.alu}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {simd_tb.simd.alu.exec_rd_exec_value }}
