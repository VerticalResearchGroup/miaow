...
# Saved on Tue Jan 29 19:50:03 2013
...
#<Session mode="View" path="/afs/cs.wisc.edu/u/m/d/mdrumond/private/miaow/src/verilog/tb/issue/debug_wave_configurations/gpu_test_issue_alu.tcl" type="Debug">
...
gui_sg_addsignal -group "$Group2" { {V1:gpu_tb.DUT[0].decode0.issue_wf_halt} {V1:gpu_tb.DUT[0].decode0.issue_valid} {V1:gpu_tb.DUT[0].decode0.issue_cc_write} {V1:gpu_tb.DUT[0].decode0.issue_cc_read} {V1:gpu_tb.DUT[0].decode0.issue_fu} {V1:gpu_tb.DUT[0].decode0.issue_wfid} {V1:gpu_tb.DUT[0].decode0.issue_imm_value1} {V1:gpu_tb.DUT[0].decode0.issue_source_reg1} {V1:gpu_tb.DUT[0].decode0.issue_source_reg2} {V1:gpu_tb.DUT[0].decode0.issue_source_reg3} {V1:gpu_tb.DUT[0].decode0.issue_dest_reg} {V1:gpu_tb.DUT[0].decode0.issue_opcode} {V1:gpu_tb.DUT[0].decode0.issue_instr_pc} }
set Group3 Group3
...
gui_sg_addsignal -group "$Group6" { {V1:gpu_tb.DUT[0].issue0.alu_dest_reg} {V1:gpu_tb.DUT[0].issue0.alu_imm_value} {V1:gpu_tb.DUT[0].issue0.alu_instr_pc} {V1:gpu_tb.DUT[0].issue0.alu_opcode} {V1:gpu_tb.DUT[0].issue0.alu_source_reg1} {V1:gpu_tb.DUT[0].issue0.alu_source_reg2} {V1:gpu_tb.DUT[0].issue0.fetchwave_wf_done_en} {V1:gpu_tb.DUT[0].issue0.fetchwave_wf_done_wf_id} {V1:gpu_tb.DUT[0].issue0.salu_alu_select} {V1:gpu_tb.DUT[0].issue0.smid0_alu_select} {V1:gpu_tb.DUT[0].issue0.smid1_alu_select} {V1:gpu_tb.DUT[0].issue0.smid2_alu_select} {V1:gpu_tb.DUT[0].issue0.smid3_alu_select} {V1:gpu_tb.DUT[0].issue0.wave_instr_issued_alu} {V1:gpu_tb.DUT[0].issue0.wavealu_wfid} }
...
gui_list_select -id ${Wave.1} {{gpu_tb.DUT[0].decode0.issue_wf_halt} }
...
gui_view_scroll -id ${Wave.1} -vertical -set 522
